...
class LIRSymbolMeta:
    ...
    This is intentionally separate from hot value slots.  Backends may keep it
    in debug tables or strip parts of it in optimized builds.
    """
...
# LIR has its own opcode vocabulary.  The "compat" subset still overlaps with
# bytecode during migration.  The "abstract-machine" subset models runtime
# mechanisms that bytecode should only encode after LIR has made them explicit.
LIROpcode = Literal[
    # -- Value loading --
